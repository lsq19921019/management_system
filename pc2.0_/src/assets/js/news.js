  ...
  fncs: {
    ...
    newsData() {
      ...
      $.ajax({
        ...
        dataType: "json",
        async: true,
        data: { belongstype: 1, pageNum: Base.getQueryParameter("pageNum") },
        url: "/api/index/articleForNewsList",
        success: function(data) {
          if (data.status == 0) {
            var resData = data.result;
            var pageNub = resData.pageEntity; //分页信息
            ...
            $(".M-box").pagination({
              ...
              callback: function(api) {
                window.location.href =
                  "./news.html?pageNum=" + api.getCurrent();
              }
            });
            for (var i = 0; i < resData.mobileNewsList.length; i++) {
              main.doms.newslist.append(`<div class="news-item">
                            ...
                            <div class="new-right">
                                ...
                                }&type=1" target="_blank"><p class="new-r-title">${
