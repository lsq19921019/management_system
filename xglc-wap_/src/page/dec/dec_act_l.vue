<template>
  <div id="act_l">
    ...
    <div class="center_l">
      ...
      <div class="gong_lue">
        <img class="title" src="static/img/l_dec_center_01.png">
        <p class="exam">例：投资<span>5万元</span>，到期收益多少？</p>
        <img src="static/img/l_dec_center_02.png?v=1.4">
        <img src="static/img/l_dec_center_03.png?v=1.5">
        <img src="static/img/l_dec_center_04.png?v=1.1">
      </div>
      <div class="bao_zhang">
