...
const getAgainOrder = (val) => {
    let re = ''
    isAgainOrder.forEach(function(obj) {
        if (obj.code == val) {
            re = obj.name
            return
        }
...
const getDistributeOrder = (val) => {
    let re = ''
    isDistributeOrder.forEach(function(obj) {
        if (obj.code == val) {
            re = obj.name
            return
        }
...
let Enum = {
    ...
    serviceType,
    getServiceType,
    isAgainOrder,isDistributeOrder,
