    ...
    var mainFn = {
        ...
        safePage: function () {
            ...
            $updatepass.find(".confirm").on("click",function(){
                var doms = {
                    domYzm:$(".code-input"),
                    domPhoneyzm:$(".phoneyzm"),
                    domPassword:$(".new-password"),
                    domPasswords:$(".password-again"),
                };
                var regObj = {
                    yzmReg:/^([0-9]){4}$/,
                    PhonCodeReg:/^([0-9]){6}$/,
                ...
                if(!yzm){
                    ...
                    mainFn.hideTip(doms.domPhoneyzm)
                    ...
                    mainFn.hideTip(doms.domPassword);
                    ...
                    mainFn.hideTip(doms.domPasswords);
