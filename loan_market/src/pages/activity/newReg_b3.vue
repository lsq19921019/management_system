    ...
    <div class="main">
        ...
        <div class="main_con">
            ...
            <div class="t1">
                ...
                <div class="tips">
                    具体放款额度，以平台实际审核为准<br>{{ companyName }}<span v-if="isShowIcp">&nbsp;&nbsp;粤ICP备17096796号-1</span><br>
                    北京市海淀区北坞村路甲25号静芯园L座西楼410A室
                </div>
            </div>
        </div>
        <!-- 图形验证码 -->
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if(this.fullPath.indexOf('/newRegB3') > -1) {
                this.companyName = '北京华巨商贸有限公司';
                this.isShowIcp = false;
            }            
        },
        mounted() {
