...
<template>
  <div>
    ...
    <div class="register in-padding" :style="{height:height + 'px'}">
      <div class="top">
        <router-link to="/start_login" replace>登录</router-link>
      ...
      <div class="content">
        ...
        <div class="input-line">
          ...
          <div class="input border-one-half-bottom">
            <input
              ...
              v-model="pw"
              style="padding-right: 11.1%;"
              placeholder="请设置登录密码（6~20位，至少含字母、数字）"
            >
          </div>
        ...
        <div class="reg-agree">
          <p>
            <img @click="agree = !agree" src="/static/img/wap_start_08.png" v-show="!agree">
            <img @click="agree = !agree" src="/static/img/wap_start_09.png" v-show="agree">
      ...
      <transition name="imgCode">
        <div id="img-code" v-show="imgCode">
          ...
          <div class="window">
            ...
            <div class="img clear">
              <img :src="base64Str">
              <span class="f5" @click="postImgCode(),codenum=''">
        ...
        .then(function(response) {
          ...
          if (resData.status == 0) {
            ...
            setTimeout(function() {
              ...
              thatData.$router.replace({ path: "/re_suc/register" });
            }, 600);
          } else {
            mui.toast(resData.msg, { duration: 1000, type: "div" });
          }
