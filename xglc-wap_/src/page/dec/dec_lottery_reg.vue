<template>
  <div id="lottery_reg">
    ...
    <div class="header">
      <img class="" src="static/img/dec_lottery_reg.jpg">
    </div>
    <div class="center">
      ...
      <div class="btn_img">
        <img id="img_btn" src="static/img/lottery_reg_btn.png">
      </div>
    </div>
    <div class="footer">
...
#lottery_reg .inputContainer {
  width: 80%;
  margin: 0 auto;
}

#lottery_reg #slideVerify {
  width: 88%;
  margin: 0 auto;
  margin-bottom: 20px;
}

#lottery_reg .inputContainer input {
  width: 100%;
  margin-bottom: 15px;
  height: 18px;
  text-indent: 25px;
...
#lottery_reg .imgCodeBox {
  height: 44px;
  width: 35%;
  float: right;
}

#lottery_reg .imgCodeBox img {
  display: block;
  width: 100%;
  height: 100%;
...
#lottery_reg .inputContainer input#validateCode,
#lottery_reg .inputContainer input#photoCode {
  border-radius: 0;
  width: 65%;
  float: left;
...
#lottery_reg .inputContainer button#validateCodeBth {
  width: 35%;
  border: none;
  outline: none;
  height: 44px;
...
#lottery_reg .btn_img img {
  display: block;
  width: 100%;
}

#lottery_reg .footer img {
  width: 51%;
  display: block;
  margin: 0 auto;
  margin-bottom: 32px;
